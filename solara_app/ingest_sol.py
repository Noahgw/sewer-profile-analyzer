"""
ingest_sol.py — GeoPandas-based ingestion module for Solara app.

Adapted from webapp/ingest_gpd.py. Handles bytes-based file uploads
instead of Streamlit's UploadedFile objects.
"""
...
def read_shapefile_from_bytes(data: bytes, filename: str):
    """
    Read a shapefile from raw bytes (Solara FileDrop).
    ...
    if filename.endswith('.zip'):
        ...
        # Single file — write it and try to read
